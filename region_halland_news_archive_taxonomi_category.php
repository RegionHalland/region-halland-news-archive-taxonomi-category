<?php
	...
	*/
	...
	function get_region_halland_news_archive_taxonomi_category_filter() {
		...
		$args = array_merge(array('post_type' => $post->post_type, 'posts_per_page' => -1), $args);
	...
	function get_region_halland_page_news_taxonomi_category_ingress($id = 0) {
		if ($id == 0) {
			return get_field('name_1000142');		
		} else {
			return get_field('name_1000142', $id);		
		}
	}
